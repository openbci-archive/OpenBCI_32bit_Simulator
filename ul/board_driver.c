...
#include <stdio.h>                  
#include <termios.h>                
#include <fcntl.h>#define _POSIX_SOURCE 1       // POSIX compliant source
#define _BSD_SOURCE
...
int wFile; //file that we are opening
...
int main(int argc, char **argv) 
{
	...
	send_to_board("2"); //to turn off channel 2 and 4, should output 56 now. 
	send_to_board("4");
	send_to_board("b");
	printf("\nSent b to board");	
